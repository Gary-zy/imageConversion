...
// node_modules/@lapo/asn1js/int10.js
var max = 1e13;
var Int10 = class {
  /**
...
// node_modules/@lapo/asn1js/oids.js
var oids = {
...
// node_modules/@lapo/asn1js/asn1.js
var ellipsis = "…";
...
var Stream = class _Stream {
  ...
  constructor(enc, pos) {
    ...
    if (typeof this.enc == "string")
      this.getRaw = (pos2) => this.enc.charCodeAt(pos2);
    else if (typeof this.enc[0] == "number")
      this.getRaw = (pos2) => this.enc[pos2];
    else
  ...
  b64Dump(start, end, type = "url") {
    ...
    for (i = start; i + 2 < end; i += 3) {
      ...
      s += b64.charAt(c >> 18 & 63);
      s += b64.charAt(c >> 12 & 63);
      s += b64.charAt(c >> 6 & 63);
      s += b64.charAt(c & 63);
    }
    if (extra > 0) {
      ...
      s += b64.charAt(c >> 18 & 63);
      s += b64.charAt(c >> 12 & 63);
      if (extra == 2) s += b64.charAt(c >> 6 & 63);
  ...
  parseStringT61(start, end, maxLength) {
    ...
    for (let i = start; i < end; ++i) {
      c = this.get(i);
      if (c >= 164 && c <= 191)
        s += "$¥#§¤\0\0«\0\0\0\0°±²³×µ¶·÷\0\0»¼½¾¿".charAt(c - 164);
      else if (c >= 224 && c <= 255)
        s += "ΩÆÐªĦ\0ĲĿŁØŒºÞŦŊŉĸæđðħıĳŀłøœßþŧŋ\0".charAt(c - 224);
      else if (c >= 192 && c <= 207)
...
//# sourceMappingURL=@lapo_asn1js.js.map
